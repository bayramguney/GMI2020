...
public class PrintOutAsPdf {
    ...
    public static void createPdf(String fileName, List<Map<String, String>> listOfMap) {
    ...
    public static PdfPTable createTable(List<Map<String, String>> listOfMap) {
    ...
    private static void addRows(PdfPTable table, List<Map<String, String>> listOfMap) {
